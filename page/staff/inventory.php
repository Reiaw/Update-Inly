    ...
    <div class="row mb-2">
        <div class="col-12">
            <div class="d-flex align-items-center">
                <form class="form-inline d-flex align-items-center flex-grow-1" method="GET">
                ...
                <button type="button" class="btn btn-primary ml-2" data-toggle="modal" data-target="#bulkWithdrawModal">
