...
(157, 117, 14, 2, 1.00, NULL),
(158, 117, 18, 1, 450.00, NULL),
(159, 117, 21, 1, 450.00, NULL),
(160, 118, 14, 1, 1.00, NULL),
(161, 118, 18, 1, 450.00, NULL);
...
(1, 369, 'quality_issue', 'WWW', '2024-11-03 21:46:52', NULL),
(2, 369, 'quality_issue', 'WWW', '2024-11-03 21:46:53', NULL),
(3, 369, 'quality_issue', 'WWW', '2024-11-03 21:47:57', NULL),
(4, 369, 'quality_issue', 'aa', '2024-11-03 21:50:30', 0x363732373864623632353630392e706e67),
(5, 370, 'quality_issue', 'aa', '2024-11-03 21:51:24', 0x363732373864656330616264372e6a7067);
...
(117, 13, 'completed', 902.00, '2024-11-02 16:02:11', '2024-11-03 10:21:53', '2024-11-03 11:15:15', 'AAAAA', NULL, '67274ec12c0d34262', 0x2e2e2f2e2e2f75706c6f61642f626172636f6465732f36373237346563313263306433343236322e706e67),
(118, 13, 'cancel', 451.00, '2024-11-02 20:47:34', NULL, NULL, 'aa', 0x706e67747265652d636f666665652d6375702d776974682d6e65777370617065722d6f6e2d7468652d776f6f64656e2d7461626c652d616e642d7468652d706c616e746174696f6e732d696d6167655f31353734303138332e6a7067, NULL, NULL);
...
(99, 117, '2024-11-02 16:02:11', 'promptpay', 902.00, 0x54584e5f32303233303232333048383479616e31614e68636c304b44332e6a7067),
(100, 118, '2024-11-02 20:47:34', 'credit_card', 451.00, NULL);
...
CREATE TABLE `product` (
  ...
  `status` enum('check','in_stock','expired','low_stock','issue','cancel') NOT NULL,
...
INSERT INTO `product` (`product_id`, `listproduct_id`, `store_id`, `expiration_date`, `status`, `quantity`, `location`, `manufacture_date`, `updated_at`, `detail_order_id`, `receipt_date`) VALUES
(368, 14, 13, '2024-11-06', 'in_stock', 25, 'ฟ', '2024-11-01', '2024-11-03 11:51:10', 157, '2024-11-03'),
(369, 14, 13, '2024-11-06', 'issue', 25, 'ฤฤฤ', '2024-11-01', '2024-11-03 14:46:52', 157, '2024-11-03'),
(370, 18, 13, '2024-11-06', 'issue', 5, 'ฆำพกหด', '2024-11-01', '2024-11-03 14:51:24', 158, '2024-11-03'),
(371, 21, 13, '2024-11-07', 'in_stock', 5, 'asdasdฟฟฟฟ', '2024-11-01', '2024-11-03 11:17:43', 159, '2024-11-03');
...
(58, 'Warut', 'Boonlue', 'warut.b@example.com', '$2y$10$EwD5heL1vZ79na5vS9ksSuLTrLg8nTaD1VdfC3VAL5p19wdxSQf/e', '0883335565', 'manager', 15, 0, '2024-10-26 05:06:30');
...
--
ALTER TABLE `detail_orders`
  MODIFY `detail_order_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=162;
...
--
ALTER TABLE `issue_product`
  MODIFY `issueproduct_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `resolution_orders`
  MODIFY `resolution_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `resolution_product`
--
ALTER TABLE `resolution_product`
  MODIFY `resolutionproduct_id` int(11) NOT NULL AUTO_INCREMENT;
